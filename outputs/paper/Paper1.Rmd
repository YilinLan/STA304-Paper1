...
Here is some body text.^[This footnote will appear at the bottom of the page.:https://github.com/YilinLan/STA304-Paper1]
...
```
Last, in figure 3, I illustrate the medium of estimated property loss under different building status. It can be seen that if the fire happened in an under-construction building, the medium property loss will be high at 500000 dollars.^[https://github.com/YilinLan/STA304-Paper1]
